...
//                                console.log("#status_"+obj[key].userID).;
				if($("#"+obj[key].userID).length) {
                                    $("#status_"+obj[key].userID).removeClass('contact-status online');
